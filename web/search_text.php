...
<div id="top" class="font-italic">본문</div>
<div><input type="text" name="maintext"  class="form-control" style="width:440px;height:100px;"  placeholder="기사의 본문을 입력해주세요" autocomplete="off"></div>
