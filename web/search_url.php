...
<div id="top" class="font-italic">URL</div>
<div><input type="text" name="url"  class="form-control" style="width:440px;height:100px;"  placeholder="기사의 URL을 입력해주세요" autocomplete="off"></div>
